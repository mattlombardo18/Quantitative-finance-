...
with st.sidebar:
    ...
    with st.expander("🔹 Core Market Variables", expanded=True):
        ...
        NSimul = st.number_input("Number of Simulations", value=100000, min_value=1000, max_value=500000, step=10000)
...
NSimul_values = np.logspace(2, 5, num=10, dtype=int)  # From 100 to 100,000

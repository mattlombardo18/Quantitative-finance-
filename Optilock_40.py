...
with st.sidebar:
    ...
    with st.expander("🔹 Core Market Variables", expanded=True):
        ...
        T = st.number_input("Maturity (Years)", value=3, min_value=1, max_value=10,help="this value must be less than or equal to 10")
        NSimul = st.number_input("Number of Simulations", value=1000, min_value=100, max_value=7500, step=250)
